...
<ul
  ...
  {#each $savedItemState.entities as entity (entity.actionLink)}
    <li class="flex justify-between gap-x-3 p-3 py-5 odd:bg-[#5ca828]">
...
<button
  class="absolute -right-3 -top-3 inline-block flex h-8 w-8 items-center justify-center rounded-full bg-[#5ca828] leading-none text-white shadow-lg hover:bg-[#5ca828]"
  on:click={close}>
  <svg
    class="h-4 w-4"
    xmlns="http://www.w3.org/2000/svg"
